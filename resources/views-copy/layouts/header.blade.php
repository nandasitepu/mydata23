<div class="lg:block hidden mx-5">
    <div class="grid grid-cols-12 gap-5 mx-5 shadow-sm rounded-b-full shadow-gray-300  ">
        <div class="col-span-3">
            <a href="/" class="flex justify-center items-center my-2">
                <img class="lg:h-24 p-1 bg-red-500 rounded-3xl" src="{{ asset('/img/logo/MY.png') }}">
                <div class="text-8xl p-2 font-bebas drop-shadow-[3px_3px_3px_var(--tw-shadow-color)] shadow-black text-white"> DATA.ID</div>
            </a>
        </div>
        <div class="col-span-6 text-center font-xl border-2 rounded-xl">
            @auth
                ...
                <div class="flex-row justify-end items-center">
                    <div class="flex justify-center items-center my-5">
                        ...
                        <a class="inline-flex" href="{{ route('redirect') }}">
                            <button
                                class="border-2 border-black px-5  shadow-[rgba(0,0,15,0.5)_5px_5px_4px_0px] inline-flex items-center ">
                    ...
                    <div class="text-center">
                        <p class="text-sm  mt-5 text-blue-500 font-bold font-italic"> Masuk - Daftar -
                            Lihat - Mainkan </p>
                    </div>
                </div>
            @endauth
        </div>
        <div class="col-span-3 text-center font-xl items-center flex">
            <div class="text-center ">
                <p
                    class="animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white pr-5 text-xl font-bold">
...
{{-- Small Screen --}}
<div class="lg:hidden block mt-[150px] ">
