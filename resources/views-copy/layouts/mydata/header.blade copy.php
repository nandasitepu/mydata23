...
<div class="lg:block hidden mb-5 ">
    <header class="py-3 z-[100]">
        <div class="grid grid-cols-12">
            <div class="col-span-5">
                {{-- Logo --}}
                <a href={{ route('welcome') }}>
                    <div class="flex justify-center items-center sm:mx-5 mt-2">
                        {{-- <img class="h-20" src="{{ asset('/img/logo/MY-trans.png') }}"> --}}
                        {{-- <div class="relative inline-block px-4 py-2 font-medium group bg-red-300">
                            <span
                            ...
                            <span
                                class="relative text-black group-hover:text-white text-xl xl:text-5xl xl:my-5 mx-2 ">
                                MYDATA.ID
                            </span>
                        </div> --}}
                        <a href="/" class="flex justify-center">
                            <img class="lg:h-24 p-1 bg-red-300" src="{{ asset('/img/logo/MY.png') }}">
                            <span class="text-4xl p-2 font-bold items-center"> DATA.ID</span>
                        </a>
                        {{-- <img class="mx-5 h-10" src="{{ asset('/img/data-plus/loveid.png') }}"> --}}
                    </div>
                </a>
            </div>

            <div class="col-span-7 sm:float-right sm:me-10 sm:order-last shadow-md">
                @auth
                ...
                @else
                    <div class="flex justify-around">
                        <div class="text-center">
                            ...
                            <p class="animate-typing overflow-hidden whitespace-nowrap border-r-4 border-r-white pr-5 text-xl font-bold">SATU DATA INDONESIA</p>
                            <p class="text-sm italic">kami validasi, sajikan, dan rapikan untuk <strong>Anda</strong></p>
                        </div>
                        <a class="inline-flex" href="{{ route('login') }}">
                            <button
                                class="border-2 border-black px-3 py-1 bg-green-400 shadow-xl  inline-flex items-center animate-pulse">
                                <span class="text-sm font-bold text-white">Gratis Gabung</span>
                            </button>
                            <button class="border-2 p-1  shadow-xl inline-flex items-center ">
                                <img class="w-8 h-8 " src="{{ asset('/img/data-plus/log-in.png') }}">
                            </button>
                        </a>
                        <a class="inline-flex" href="{{ route('redirect') }}">
                            <button class="border-2 border-black px-5  shadow-[rgba(0,0,15,0.5)_5px_5px_4px_0px] inline-flex items-center ">
                                <span class="text-sm font-bold">Login</span>
                            </button>
                            <button class="border-2 border-black px-5  shadow-[rgba(0,0,15,0.5)_5px_5px_4px_0px] inline-flex items-center ">
                                <img class="w-8 h-8 p-1" src="{{ asset('/img/data-plus/google-symbol.png') }}">
                            </button>
                            {{-- <button class="border-2 border-black px-5  shadow-[rgba(0,0,15,0.5)_10px_5px_4px_0px] inline-flex items-center ">
                                <img class="w-8 h-8 p-1" src="{{ asset('/img/data-plus/facebook.png') }}">
                            </button> --}}
                        </a>

                    </div>
                    <p class="text-sm text-right mt-5 text-blue-500 font-bold font-italic"> Masuk - Daftar -
                        Lihat - Mainkan </p>
                @endauth
            </div>
        </div>
...
<div class="block lg:hidden mb-20 ">
    <nav class="bg-white border-b border-gray-200 p-1 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-[100] sm:mb-100"
        id="logo-bar">
