<x-main-layout>
    <div class="mx-5 my-5">
        <div class="grid grid-cols-12 font-sans">
            <div class="col-span-12">
                <div class="text-2xl font-bold">Pedoman Media Siber</div>
                <hr class="border-2 border-black mb-5">
                <div class="text-justify border-b-2 border-black border-dashed mb-5">
                    <p>
                    ...
                    <br>
                    <p class="text-xl mb-5 font-semibold">Ruang Lingkup</p>
                    <ol class="list-alphabet ml-10">
                        <li>
                    ...
                    <br>
                    <p class="text-xl mb-5 font-semibold">
                        ...
                        <li>Ketentuan dalam butir (a) di atas dikecualikan, dengan syarat:
                            <ul class="list-disc ml-5">
                                ...
                                <li> Sumber berita yang pertama adalah sumber yang jelas disebutkan identitasnya,
                                    kredibel dan
                                    kompeten;</li>
                                <li>Subyek berita yang harus dikonfirmasi tidak diketahui keberadaannya dan atau tidak
                                    dapat
                                    diwawancarai;</li>
                            </ul>
                        </li>
                        <li>Media memberikan penjelasan kepada pembaca bahwa berita tersebut masih memerlukan verifikasi
                            lebih lanjut yang diupayakan dalam waktu secepatnya</li>
                        <li> Penjelasan dimuat pada bagian akhir dari berita yang sama, di dalam kurung dan menggunakan
                            huruf
                            miring.</li>
                        <li> Setelah memuat berita sesuai dengan butir (c), media wajib meneruskan upaya verifikasi, dan
                            setelah
                    ...
                    <br>
                    <p class="text-xl mb-5 font-semibold"> Isi Buatan Pengguna (User Generated Content)</p>
                    <ol class="list-alphabet ml-10">
                        <li> Media siber wajib mencantumkan syarat dan ketentuan mengenai Isi Buatan Pengguna yang tidak
                            bertentangan
                        ...
                        <li> Media siber mewajibkan setiap pengguna untuk melakukan registrasi keanggotaan dan melakukan
                            proses
                        ...
                        <li> Dalam registrasi tersebut, media siber mewajibkan pengguna memberi persetujuan tertulis
                            ...
                            <ol class="list-disc ml-5">
                                ...
                                <li>Tidak memuat isi diskriminatif atas dasar perbedaan jenis kelamin dan bahasa, serta
                                    tidak merendahkan martabat orang lemah, miskin, sakit, cacat jiwa, atau cacat
                                    jasmani.</li>

                            </ol>
                        </li>
                        <li> Media siber memiliki kewenangan mutlak untuk mengedit atau menghapus Isi Buatan
                            Pengguna yang bertentangan dengan butir (c).</li>
                        ...
                        <li> Media siber wajib menyunting, menghapus, dan melakukan tindakan koreksi setiap Isi Buatan
                        ...
                        <li> Media siber yang telah memenuhi ketentuan pada butir (a), (b), (c), dan (f) tidak dibebani
                            tanggung jawab atas masalah yang ditimbulkan akibat pemuatan isi yang melanggar ketentuan
                            pada butir (c).</li>
                        <li> Media siber bertanggung jawab atas Isi Buatan Pengguna yang dilaporkan bila tidak mengambil
                            tindakan koreksi setelah batas waktu sebagaimana tersebut pada butir (f).</li>
                    </ol>
                    <br>
                    <p class="text-xl mb-5 font-semibold">
                    ...
                    <ol class="list-alphabet ml-10">
                        <li> Ralat, koreksi, dan hak jawab mengacu pada Undang-Undang Pers, Kode Etik Jurnalistik, dan
                            Pedoman Hak Jawab yang ditetapkan Dewan Pers.</li>
                        <li> Ralat, koreksi dan atau hak jawab wajib ditautkan pada berita yang diralat, dikoreksi atau
                            yang diberi hak jawab.</li>
                        ...
                        <li> Bila suatu berita media siber tertentu disebarluaskan media siber lain, maka:
                            <ul class="list-disc ml-5">
                                <li> Tanggung jawab media siber pembuat berita terbatas pada berita yang dipublikasikan
                                    di media
                                    siber tersebut atau media siber yang berada di bawah otoritas teknisnya;</li>
                    ...
                    <br>
                    <p class="text-xl font-semibold mb-5">Pencabutan Berita</p>
                    <ol class="list-alphabet ml-10">
                        <li> Berita yang sudah dipublikasikan tidak dapat dicabut karena alasan penyensoran dari pihak
                            luar
                            redaksi,
                            kecuali terkait masalah SARA, kesusilaan, masa depan anak, pengalaman traumatik korban atau
                            berdasarkan
                            pertimbangan khusus lain yang ditetapkan Dewan Pers.</li>
                    ...
                    <p class="text-xl font-semibold my-5"> Hak Cipta</p>
                    <p>
                    ...
                    <p class="text-xl font-semibold my-5"> Pencantuman Pedoman</p>
                    <p>

                        Media siber wajib mencantumkan Pedoman Pemberitaan Media Siber ini di medianya secara terang dan
                        jelas.
                    </p>
                    <p class="text-xl font-semibold my-5"> Sengketa</p>
                    <p>
