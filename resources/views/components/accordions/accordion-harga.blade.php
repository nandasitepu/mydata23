    ...
    <div x-data="{ expanded: false }" class="py-2">
        <h2>
            <button id="harga" type="button"
                class="flex items-center justify-between w-full text-left font-semibold py-2 px-5 shadow-red-500 bg-white shadow-sm"
        ...
        <div id="harga" role="region" aria-labelledby="harga"
            class="grid text-sm text-slate-600 overflow-hidden transition-all duration-300 ease-in-out"
            :class="expanded ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'">
            <div class="overflow-hidden">
                <p class="pb-3 ">
                    {{-- Produk dan Jasa --}}
                <div class="grid grid-cols-auto  bg-white">
                    {{-- Subscription --}}
