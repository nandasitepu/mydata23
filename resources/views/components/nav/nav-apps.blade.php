<div>
                        ...
                        <!-- Apps Dropdown menu -->
                        <div class="hidden overflow-hidden  my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                            id="apps-dropdown">
                            <div
