<div>
    ...
    <button type="button"
        ...
        <img class="rounded-lg w-6 h-6" src="{{ asset('/img/data-plus/avatar.png') }}" alt="mydata_user">
    </button>
    <!-- User's Dropdown menu -->
    <div class="hidden my-4 w-56 text-base list-none bg-white  divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
        id="dropdown">
        <div class="py-3 px-4">
