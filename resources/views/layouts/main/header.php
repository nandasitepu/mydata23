{{-- Separator --}}
        ...
        <nav class="hidden md:block">
            <div class="grid md:grid-cols-5">
                {{-- Login /  Forum --}}
                <div class="col self-center sm:order-last">
                    @auth
                        <div class="flex justify-around">
                            ...
                            <a href="{{ route('dashboard') }}" class="font-mono font-bold shadow-md"><button
                                    type="button"
                                    class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                                    Dashboard
                                </button></a>
                            ...
                            <button type="button"
                                ...
                                <img class="rounded-lg w-8" src="{{ asset('/img/data-plus/avatar.png') }}"
                                    alt="mydata_user">
                            </button>
                ...
                {{-- Logo --}}
                <div class="col">
                    <a class= "px-5" href={{ route('welcome') }}>
                ...
                <div class="md:col-span-3 col hidden lg:block">
                    <div class="text-center self-center">
                        ...
                        <div class="text-3xl font-bebas bg-gray-50 m-10">
        ...
        {{-- Mobile View --}}
        <nav class="block md:hidden fixed left-0 right-0 top-0 py-2  bg-gray-100 z-50" id="logo-bar">
            ...
            @else
                <div class="flex justify-around font-mono border-b-2">
                    <div class="inline-flex items-center">
                        <a href="{{ route('login') }}" class="m-2">
                            <div class="items-center border-2 p-1 shadow-xl text-sm"><img class="w-8 h-8 "
                                    src="{{ asset('/img/data-plus/log-in.png') }}"></div>
                ...
                <div class="text-center">
                    <p class="text-sm  font-grape" id="masuk"> Masuk / Daftar / Lihat-Lihat </p>
                </div>
            @endauth
