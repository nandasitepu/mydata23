      ...
      <div x-data="{ expanded: true }" class="py-2">
          <h2>
              <button id="faqs-title-02" type="button"
                  class="flex items-center justify-between w-full text-left font-semibold py-2 px-5 shadow-green-500 shadow-sm"
                  @click="expanded = !expanded" :aria-expanded="expanded" aria-controls="faqs-text-02">
                  <span>
                    <span class="border px-2 border-black bg-red-100 shadow-md">Data</span>
                    -
                    <span class="border px-2 border-black bg-yellow-100 shadow-md">Infografis</span>
                    -
                    <span class="border px-2 border-black bg-green-100 shadow-md">Tabel</span>
                    -
                    <span class="border px-2 border-black bg-blue-100 shadow-md">Gambar Unik</span>
