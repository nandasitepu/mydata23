<div class="grid grid-cols-12 gap-1">
    <div class="col-span-12 sm:col-span-8 hidden sm:block">
        @include('layouts.mydata.top-menu1')

    </div>
    <div class="col-span-12 sm:col-span-4 text-center font-mono px-5">
        <div class="flex justify-end items-center"><img class="w-20 mb-3" src="{{ asset('/img/linktree-qr.png') }}"></div>
        <a href="{{ route('permintaan') }}">
            <button type="button"
                class="text-left w-full py-1 mb-3 px-4 bg-gray-200 border-2 shadow-xl border-black">
                Minta Data <i class="fa fa-download float-right py-1" aria-hidden="true"></i>
            </button>
        </a>
        <a href="{{ route('permintaan') }}">
            <button type="button"
                class="text-left w-full py-1 mb-3 px-4 bg-red-200 border-2 shadow-xl border-black">
        ...
        <a href="{{ route('tentang-kami') }}">
            <button type="button"
                class=" text-left w-full py-1 mb-3 px-4 bg-blue-200 border-2 shadow-xl border-black">
