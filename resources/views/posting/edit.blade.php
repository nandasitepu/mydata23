<x-main-layout>
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-5xl px-4 py-8 mx-auto lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Posting</h2>
            <form action="{{ route('posting.update', $post->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="judul" id="judul"
                            ...
                            value="{{ old('judul', $post->judul) }}" placeholder="Judul Posting" >
                    </div>
                    <div class="sm:col-span-2">
                        <label for="image"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Main Image URL</label>
                       <img src="{{ old('gambar', $post->gambar) }}" alt="" srcset="">
                        <input type="url" name="gambar" id="image"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{ old('image', $post->gambar) }}">
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="penulis" id="Penulis"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{ old('penulis', $post->penulis) }}" placeholder="Nama Penulis">
                    </div>
                    <div class="w-full">
                        ...
                        <input type="date" name="created_at" id="created_at"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{ old('created_at', $post->created_at->format('Y-m-d')) }}" placeholder="";
                            >
                    </div>
                    <div>
                        <label for="Kategori"
                        ...
                        <select id="Kategori"
                            ...
                            name="kategori"
                            >
                            <option  selected value="{{ old('kategori', $post->kategori) }} ">
                                {{ old('kategori', $post->kategori) }}
                            </option>
