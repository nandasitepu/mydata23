                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <x-secondary-button class="bg-white text-sm">
                        ...
                        <x-secondary-button class="bg-white ml-2">
                                ...
                                class=" text-sm text-gray-700 dark:text-gray-500">Register
                            </a>
                        </x-secondary-button>
    ...
    <div
        ...
        <figure
            ...
            <div class="space-y-0.5 font-medium dark:text-white text-center rtl:text-right ms-3">
                ...
                <div class="text-white dark:text-gray-400 text-2xl font-extrabold">Hukum</div>
        ...
        <figure
            ...
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                ...
                <div class=" text-white dark:text-gray-400 text-2xl font-extrabold">Pendidikan</div>
            </div>
        </figure>
        <figure
            ...
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                <div class="text-white dark:text-gray-400 text-2xl font-extrabold">Kesehatan</div>
            </div>
        </figure>
