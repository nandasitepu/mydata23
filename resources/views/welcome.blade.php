...
<head>
    ...
    <title>mydata.id - dataku datamu</title>
...
<body>
    ...
    <header class="antialiased">
        <nav class="bg-white border-gray-700 shadow-xl px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-around items-center">
                <div class="flex items-center text-center">
                    ...
                    <a href="#">
                        {{-- <img src="#" class="mr-3 h-8" alt="MyDATA" /> --}}
                        <span class="font-extrabold text-2xl">MYDATA.ID</span>
                    </a>
    ...
    {{--  --}}
    {{-- <div class="justify-center flex rounded- shadow-xxl p-5" role="group">
        <button type="button"
    ...
    <div class="m-5 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400 rtl:divide-x-reverse"
            ...
            <li class="w-full">
                <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq"
                    aria-selected="false"
                    class="inline-block w-full p-4 rounded-se-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Tanya
                    & Jawab</button>
            </li>
        </ul>
        <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about" role="tabpanel"
                ...
                <h2 class="mb-5 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">Kami Mengumpulkan
    ...
    {{--  --}}
    <div
        class="grid border-2 m-5 border-gray-100 shadow-sm dark:border-white md:mb-12 md:grid-cols-3 bg-white dark:bg-gray-100">
        <figure
            class="flex flex-col items-center justify-center p-8 text-center bg-black border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-ss-lg md:border-e dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                ...
                <div class="text-white dark:text-gray-400 text-2xl font-extrabold">MyData - Hukum</div>
            </div>
        </figure>
        <figure
            class="flex flex-col items-center justify-center p-8 text-center bg-green-500 border-b border-gray-200 md:rounded-se-lg dark:bg-gray-800 dark:border-gray-700">
            <figcaption class="flex items-center justify-center">
                <img class="rounded-lg w-40" src="{{ asset('\img\mydata_pendidikan.png') }}" alt="mydata_hukum">
            </figcaption>
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">

                <div class=" text-white dark:text-gray-400 text-2xl font-extrabold">MyData - Pendidikan</div>
            </div>
        </figure>
        <figure
            class="flex flex-col items-center justify-center p-8 text-center bg-red-500 border-b border-gray-200 md:rounded-es-lg md:border-b-0 md:border-e dark:bg-gray-800 dark:border-gray-700">
            <figcaption class="flex items-center justify-center">
                <img class="rounded-lg w-40" src="{{ asset('\img\mydata_kesehatan.png') }}" alt="mydata_hukum">
            </figcaption>
            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                <div class="text-white dark:text-gray-400 text-2xl font-extrabold">MyData - Kesehatan</div>
            </div>
        </figure>
    ...
    {{--  --}}
    <div class="bg-white py-22 sm:py-32">
